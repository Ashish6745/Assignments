...
<footer class="bg-[#DF2E38] text-center text-white mt-12">
  <div class="container px-6 pt-6">
    ...
    <div class="mb-6">
      <p>
      SchoTest: An initiative of S.J.J. Solutions Pvt. Ltd. is here to fulfill its social responsibility towards the society. We dream to revolutionize the educational system of this era by unleashing the creative potential of the students and help them advance in the educational realm.
      </p>
    </div>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-4">
      <div class="mb-6">
        ...
        <ul class="mb-0 list-none">
          ...
          <li>
            <a href="#!" class="text-white">Students</a>
          </li>
          <li>
      ...
      <div class="mb-6">
        ...
        <ul class="mb-0 list-none">
          ...
          <li>
            <a href="#!" class="text-white">Teacher</a>
          </li>
          <li>
      ...
      <div class="mb-6">
        ...
        <ul class="mb-0 list-none">
          ...
          <li>
            <a href="#!" class="text-white">Email@info.com</a>
          </li>
          <li>
  ...
  <div
    ...
    © 2023 Copyright:
    <a class="text-white" href="https://schotest.com/"
      >SchoTest</a
    >
  </div>
</footer>
